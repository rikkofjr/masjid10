        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('zis_name', $ZisType, null, array('class'=>'form-control', 'placeholder'=>'Plih Jenis ZIS......')) }}
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <hr>
                        <div class="form-group">
                            {{ Form::label('uang', 'Total Uang zis') }}
                    ...
                    <div class="col-md-6">
                        ...
                        <hr>
                        <div class="form-group">
                            {{ Form::label('beras', 'Beras ZIS - gunakan titik untuk angka desimal')}}
