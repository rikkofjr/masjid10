    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                {{ Form::model($qurban, array('route' => array('admin.qurban.update', $qurban->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data')) }}
                <div class="form-group">
                    Jenis Hewan <b style="color:red;">*</b>{{$qurban->jenis_hewan}}
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="{{$qurban->nomor_handphone}}" name="nomor_handphone" class="form-control">
                            </div>
                        </div>
                        ...
                        <img width="150px" src="{{asset('/upload/qurban/'.$qurban->photo_hewan)}}" alt="" srcset="">
                        <div class="form-group">
                            {{Form::hidden('old_photo_hewan', $qurban->photo_hewan, array(''))}}
                            {{ Form::label('photo_hewan', 'Photo Hewan') }}
                            {!! Form::file('photo_hewan', null,array('class' => 'photo_hewan')) !!}
                        </div>
