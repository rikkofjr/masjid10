...
<div class="box">
    <table class="table" width="100%">
        ...
        <tr>
            <td colspan="2">No : <b>{{$dataQurban->jenis_hewan}}-{{ preg_replace('/[^0-9]/', '', $dataQurban->nomor_hewan) }}</b> | {{$dataQurban->disaksikan}}</td>
        </tr>
        <tr>
            <td>Atas Nama </td>
        ...
        <tr>
            <td valign="top" colspan="2"> <b>Nama Lainnya</b></td>
        </tr>
        <tr>
            <td colspan="2">{!! nl2br(e($dataQurban->nama_lain)) !!}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td valign="top" colspan="2"> <b>Permintaan</b></td>
        </tr>
        <tr>
            <td colspan="2">{!! nl2br(e($dataQurban->permintaan)) !!}</td>
        </tr>
        <tr>
            <td colspan="2">
                <img src="{{asset('/upload/qurban/'.$dataQurban->photo_hewan)}}" alt="" width="90%">
