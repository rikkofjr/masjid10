    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                {{ Form::open(array('route' => 'admin.qurban.store', 'enctype' => 'multipart/form-data'))}}
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nomor_handphone" placeholder="812xxxx" class="form-control">
                            </div>
                        </div>
                        <br />Keterangan Disaksikan
                        <select name="disaksikan" id="" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::file('photo_hewan', array('class' => 'photo_hewan')) !!}
                        </div>
                    </div>
                </div>
