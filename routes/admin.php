...
//Permission Humas
Route::group(['middleware' => ['can:humas-create']], function(){
...
//can do soft delete
Route::group(['middleware' => ['permission:outsource-delete|dkm-delete'], 'prefix' => 'softdelete' ,'as' => 'softdelete.'], function(){
    Route::delete('/keluarga/{id}', [DataJamaahController::class, 'SoftDelete'])->name('keluarga');
    Route::delete('/data-jamaah/{id}', [DataJamaahController::class, 'SoftDeleteByJamah'])->name('jamaah');
    Route::delete('/zis/{id}', [ZisController::class, 'SoftDeleteById'])->name('zis');
    Route::delete('/qurban/{id}', [QurbanController::class, 'SoftDeleteById'])->name('qurban');
});
...
Route::group(['prefix' => 'api', 'as' => 'api.'],function(){
    ...
    Route::get('/kategori-transaksi', [KasKategoriController::class, 'getSearchKategori'])->name('all.kategoriTransaksi');
